...
<head>
  ...
  <link href="../assets/demo/imageupload.css" rel="stylesheet" />
</head>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <form id="productFromdata">
                        ...
                        <div class="col-md-4 form-group">
                          <label class="bmd-label-floating">Select Category</label>
                            <select type="text" class="form-control" name="category">
                              ...
                              <option>Recycled Products</option>
                              <option>Gardening Products</option>
                            </select>
                        </div> 
                      </div>
                    <div class="row">
                    ...
                    <div class="row">
                      <div class="col-md-5 form-group">
                        <label class="bmd-label-floating">Added By</label>
                        <input type="text" class="form-control" readonly="true" value="<?php echo $_SESSION['username'] ?>"
                        name="addedBy">
                      </div>
                      <div class="col-md-5 form-group">
                        <label class="bmd-label-floating">Added Date</label>
                        <input type="date" class="form-control" name="addedDate">
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-5 form-group">
                        <input type="checkbox" class="form-check" id="feature" name="isFeature">
                        <label for="feature">is Feature</label>
                      </div>
                    </div>
                        ...
                        <div class="col-sm-2 imgUp">
                          ...
                          <div class="imagePreview"></div>
                            <label class="btn btn-primary">
                                Upload
                            <input type="file" class="uploadFile img" value="Upload Photo" name="image" style="width: 0px;height: 0px;overflow: hidden;">
                            </label>
                        </div>
                        <div class="col-sm-2">
                            <div id="err"></div>
