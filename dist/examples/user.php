                                ...
                                <form id="registerfromdata">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 form-group">
                                            ...
                                            <input type="text" class="form-control" name="userNic">
                                        </div>
                                        <div class="col-md-4 form-group">
...
<!--                                        </div>-->
<!--                                        <div class="col-md-5 form-group">-->
<!--                                            <label class="bmd-label-floating">Updated Date</label>-->
<!--                                            <input type="date" class="form-control">-->
<!--                                        </div>-->
<!--                                    </div>-->
                                    <div class="row">
                                        <div class="col-md-5 form-group">
                                            <input type="checkbox" class="form-check" name="isActive">
                                            <label>Active</label>
                                        </div>
                                    </div>


                                    <button type="button" class="btn btn-primary pull-right" id="register">Save User
                                    </button>
